...
By default the template creates a single `HelloWorld` contract under irish_vehicle_registry folder in the `smart_contracts` directory. To add a new contract:
